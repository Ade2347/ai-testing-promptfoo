...
async function matchesContextRecall(context, groundTruth, threshold, grading, vars) {
    ...
    for (const sentence of sentences) {
        const isAttributed = sentence.includes(prompts_1.CONTEXT_RECALL_ATTRIBUTED_TOKEN);
        if (isAttributed) {
            numerator++;
        }
...
async function matchesContextRelevance(question, context, threshold, grading) {
    ...
    const insufficientInformation = resp.output.includes(prompts_1.CONTEXT_RELEVANCE_BAD);
    let numerator = 0;
