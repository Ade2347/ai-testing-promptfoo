        ...
        for (const node of currentBestNodes) {
            ...
            for (let i = 0; i < BRANCHING_FACTOR; i++) {
                ...
                if (redteamTokenUsage) {
                    (0, tokenUsageUtils_1.accumulateTokenUsage)(totalTokenUsage, redteamTokenUsage);
                }
                attempts++;
                ...
                if (isOnTopicTokenUsage) {
                    (0, tokenUsageUtils_1.accumulateTokenUsage)(totalTokenUsage, isOnTopicTokenUsage);
                }
