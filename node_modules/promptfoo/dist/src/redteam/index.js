...
async function applyStrategies(testCases, strategies, injectVar, excludeTargetOutputFromAgenticAttackGeneration) {
    ...
    for (const strategy of strategies) {
        ...
        if (strategy.id.startsWith('file://')) {
            ...
            let builtinStrategy = strategies_1.Strategies.find((s) => s.id === strategy.id);
            ...
            if (!builtinStrategy && strategy.id.includes(':')) {
                ...
                builtinStrategy = strategies_1.Strategies.find((s) => s.id === baseStrategyId);
            }
            if (!builtinStrategy) {
        ...
        const applicableTestCases = testCases.filter((t) => pluginMatchesStrategyTargets(t, strategy.id, targetPlugins));
