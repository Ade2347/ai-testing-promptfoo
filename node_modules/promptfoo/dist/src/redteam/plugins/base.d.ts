...
export declare abstract class RedteamGraderBase {
    ...
    getResult(prompt: string, llmOutput: string, test: AtomicTestCase, provider: ApiProvider | undefined, renderedValue: AssertionValue | undefined, additionalRubric?: string): Promise<{
        grade: GradingResult;
        rubric: string;
