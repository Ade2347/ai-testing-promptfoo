...
async function callSimbaApi(endpoint, data) {
    ...
    logger_1.default.debug(`Calling Simba API: ${url}`);
    logger_1.default.debug(`Request data: ${JSON.stringify(data)}`);
...
async function runSimbaSession(options, testSuite) {
    ...
    while (true) {
        ...
        try {
            ...
            logger_1.default.debug(`Next response: ${JSON.stringify(batchResponse)}`);
