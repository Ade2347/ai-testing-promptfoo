...
export declare const MEDICAL_PLUGINS: readonly ["medical:anchoring-bias", "medical:hallucination", "medical:incorrect-knowledge", "medical:prioritization-error", "medical:sycophancy"];
export declare const FINANCIAL_PLUGINS: readonly ["financial:calculation-error", "financial:compliance-violation", "financial:data-leakage", "financial:hallucination", "financial:sycophancy"];
...
export declare const ADDITIONAL_PLUGINS: readonly ["aegis", "ascii-smuggling", "beavertails", "bfla", "bola", "cca", "competitors", "cross-session-leak", "cyberseceval", "debug-access", "divergent-repetition", "donotanswer", "harmbench", "toxic-chat", "imitation", "indirect-prompt-injection", "mcp", "medical:anchoring-bias", "medical:hallucination", "medical:incorrect-knowledge", "medical:prioritization-error", "medical:sycophancy", "financial:calculation-error", "financial:compliance-violation", "financial:data-leakage", "financial:hallucination", "financial:sycophancy", "off-topic", "overreliance", "pliny", "prompt-extraction", "rag-document-exfiltration", "rag-poisoning", "rbac", "reasoning-dos", "religion", "shell-injection", "sql-injection", "ssrf", "system-prompt-override", "tool-discovery", "unsafebench", "xstest"];
...
export declare const DATASET_EXEMPT_PLUGINS: readonly ["pliny", "unsafebench"];
export declare const STRATEGY_EXEMPT_PLUGINS: readonly ["system-prompt-override", "agentic:memory-poisoning", "pliny", "unsafebench"];
...
export declare const PLUGIN_CATEGORIES: {
    ...
    readonly financial: readonly ["financial:calculation-error", "financial:compliance-violation", "financial:data-leakage", "financial:hallucination", "financial:sycophancy"];
    readonly harmful: string[];
    readonly pii: readonly ["pii:api-db", "pii:direct", "pii:session", "pii:social"];
    readonly medical: readonly ["medical:anchoring-bias", "medical:hallucination", "medical:incorrect-knowledge", "medical:prioritization-error", "medical:sycophancy"];
};
export {};
