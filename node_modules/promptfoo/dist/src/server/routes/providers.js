...
exports.providersRouter.post('/test', async (req, res) => {
    ...
    const loadedProvider = await (0, providers_1.loadApiProvider)(providerOptions.id, {
        options: {
            ...providerOptions,
            config: {
    ...
    try {
        ...
        logger_1.default.debug((0, dedent_1.default) `[POST /providers/test] Calling agent helper
        result: ${JSON.stringify(result)}
        providerOptions: ${JSON.stringify(providerOptions)}`);
