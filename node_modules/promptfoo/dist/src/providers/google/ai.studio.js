...
exports.AIStudioChatProvider = void 0;
...
class AIStudioChatProvider extends AIStudioGenericProvider {
    ...
    async callGemini(prompt, context) {
        ...
        const { contents, systemInstruction } = (0, util_2.geminiFormatAndSystemInstructions)(prompt, context?.vars, config.systemInstruction);
        ...
        const allTools = [...mcpTools, ...(config.tools ? (0, util_2.loadFile)(config.tools, context?.vars) : [])];
        ...
        if (config.responseSchema) {
            ...
            const schema = (0, file_1.maybeLoadFromExternalFile)((0, util_1.renderVarsInObject)(config.responseSchema, context?.vars));
