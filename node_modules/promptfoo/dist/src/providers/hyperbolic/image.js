...
function formatHyperbolicImageOutput(imageData, prompt, responseFormat) {
...
class HyperbolicImageProvider {
    ...
    async callApi(prompt, context, callApiOptions) {
        ...
        logger_1.default.debug(`Calling Hyperbolic Image API: ${JSON.stringify(body)}`);
        const headers = {
        ...
        logger_1.default.debug(`\tHyperbolic image API response: ${JSON.stringify(data)}`);
        if (data.error) {
            return {
